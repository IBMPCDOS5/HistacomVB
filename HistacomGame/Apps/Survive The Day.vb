Public Class Survive_The_Day
    ...
    Private Sub Survive_The_Day_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        winman.setupwindow(Me, "Survive the Day", My.Resources.survive_the_day_icon)
    End Sub
End Class